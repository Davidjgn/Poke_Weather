//Ajax -jQuery --> API to fetch the pokemon data
function showpkmTypes(desc, imgId) {
  ...
  $.ajax({
    ...
    .done(function (data) {
      const currentPokemonList = data.pokemon;
...
function utcConverter(seconds) {
  ...
  const hoursText =
    hours < 0 ? `UTC ${hours}:` : hours > 0 ? `UTC +${hours}:` : "";
  const minutesText =
    minutes < 0
      ? `${Math.abs(minutes)}`
      : minutes > 0
...
function fetchForecast() {
  ...
  fetch(apiUrl) // Replace with your API endpoint
    ...
    .then((data) => {
      ...
      document.getElementById("date1").innerHTML = unixConverter1(
        data.list[3].dt
      );
      ...
      document.getElementById("date2").innerHTML = unixConverter1(
        data.list[11].dt
      );
      ...
      document.getElementById("date3").innerHTML = unixConverter1(
        data.list[19].dt
      );
      ...
      document.getElementById("date4").innerHTML = unixConverter1(
        data.list[27].dt
      );
      ...
      document.getElementById("date5").innerHTML = unixConverter1(
        data.list[35].dt
      );
      ...
      document.getElementById("icon1").src =
        "https://openweathermap.org/img/wn/" + icon1Src + ".png";
      //Icon POKEMON 1
      ...
      document.getElementById("icon2").src =
        "https://openweathermap.org/img/wn/" + icon2Src + ".png";
      //Icon POKEMON 2
      ...
      document.getElementById("icon3").src =
        "https://openweathermap.org/img/wn/" + icon3Src + ".png";
      //Icon POKEMON 3
      ...
      document.getElementById("icon4").src =
        "https://openweathermap.org/img/wn/" + icon4Src + ".png";
      //Icon POKEMON 4
      ...
      document.getElementById("icon5").src =
        "https://openweathermap.org/img/wn/" + icon5Src + ".png";
      //Icon POKEMON 5
      ...
      document.getElementById("pop1").innerHTML =
        "<strong>POP: </strong>" + Math.round(100 * data.list[3].pop) + "%";

      //second day
      document.getElementById("pop2").innerHTML =
        "<strong>POP: </strong>" + Math.round(100 * data.list[11].pop) + "%";

      //third day
      document.getElementById("pop3").innerHTML =
        "<strong>POP: </strong>" + Math.round(100 * data.list[19].pop) + "%";

      //fourth day
      document.getElementById("pop4").innerHTML =
        "<strong>POP: </strong>" + Math.round(100 * data.list[27].pop) + "%";

      //fifth day
      document.getElementById("pop5").innerHTML =
        "<strong>POP: </strong>" + Math.round(100 * data.list[35].pop) + "%";
